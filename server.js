...
/* harmony import */ var helmet__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(162);
...
app.use(
  helmet__WEBPACK_IMPORTED_MODULE_2___default()({
    referrerPolicy: { policy: "no-referrer" },
  })
);

app.use(
  helmet__WEBPACK_IMPORTED_MODULE_2___default.a.hsts({
    maxAge: 2592000,
  })
);
...
app.use(
  helmet__WEBPACK_IMPORTED_MODULE_2___default.a.frameguard({
    action: "sameorigin",
  })
);

app.use(
  helmet__WEBPACK_IMPORTED_MODULE_2___default.a.contentSecurityPolicy({
    directives: {
      defaultSrc: ["*"],
      scriptSrc: [
        "'self'",
        "'unsafe-inline'",
        "'unsafe-eval'",
        "cdnbolddeskstaging.blob.core.windows.net",
        "*.stripe.com",
        "*.xing-share.com",
        "*.xing.com",
        "*.hotjar.com",
        ...
        "*.addthis.com",
        "m.addthisedge.com",
        "dev-reverse-proxy-helpdesk.azurewebsites.net",
        "*.bolddesk.com",],
      objectSrc: ["'none'"],
      styleSrc: ["'self'",
       "cdnbolddeskstaging.blob.core.windows.net",
       ...
       "*.xing-share.com",
       "fonts.gstatic.com",
       "*.xing.com", "*.bootstrapcdn.com", "*.syncfusion.com", "cdn.swaychat.com", "*.google.com", "*.googleapis.com", "cdn.jsdelivr.net", "cdn.rawgit.com"],
      frameSrc: ["'self'", "cdn.swaychat.com", "*.stripe.com", "*.facebook.com", "*.xing-share.com", "*.xing.com", "*.hotjar.com", "*.opmnstr.com", "*.firebaseio.com", "*.syncfusion.com", "bid.g.doubleclick.net", "*.addthis.com", "www.youtube.com", "api.swayio.com", "*.google.com", "www.gstatic.com", "*.gstatic.com"],
      mediaSrc: ["'none'"],
      baseUri: ["'self'"],
      fontSrc: ["'self'", "data:", "fonts.gstatic.com", "cdnbolddeskstaging.blob.core.windows.net", "*.bolddesk.com", "*.syncfusion.com"]
    },
  })
);

app.use(express__WEBPACK_IMPORTED_MODULE_0___default.a.static('./'));

app.get('*', (req, res) => {
  res.sendFile(path__WEBPACK_IMPORTED_MODULE_1___default.a.resolve('./index.html'));
});
...
var Router = __webpack_require__(107);
...
exports.query = __webpack_require__(121);
exports.raw = bodyParser.raw
exports.static = __webpack_require__(161);
...
var first = __webpack_require__(79)
...
var query = __webpack_require__(121);
var debug = __webpack_require__(109)('express:application');
var View = __webpack_require__(127);
var http = __webpack_require__(118);
var compileETag = __webpack_require__(129).compileETag;
var compileQueryParser = __webpack_require__(129).compileQueryParser;
var compileTrust = __webpack_require__(129).compileTrust;
var deprecate = __webpack_require__(4)('express');
var flatten = __webpack_require__(114);
...
var debug = __webpack_require__(98)('finalhandler')
var encodeUrl = __webpack_require__(103)
var escapeHtml = __webpack_require__(104)
var onFinished = __webpack_require__(78)
var parseUrl = __webpack_require__(105)
var statuses = __webpack_require__(15)
var unpipe = __webpack_require__(56)
...
var Route = __webpack_require__(108);
var Layer = __webpack_require__(115);
var methods = __webpack_require__(117);
var mixin = __webpack_require__(119);
var debug = __webpack_require__(109)('express:router');
var deprecate = __webpack_require__(4)('express');
var flatten = __webpack_require__(114);
var parseUrl = __webpack_require__(105);
var setPrototypeOf = __webpack_require__(14)
...
var debug = __webpack_require__(109)('express:router:route');
var flatten = __webpack_require__(114);
var Layer = __webpack_require__(115);
var methods = __webpack_require__(117);
...
var debug = __webpack_require__(109)('express:router:layer');
...
var debug = __webpack_require__(109)('express:view');
...
function View(name, options) {
  ...
  if (!opts.engines[this.ext]) {
    ...
    var fn = __webpack_require__(128)(mod).__express
...
var contentDisposition = __webpack_require__(131);
var contentType = __webpack_require__(12);
var deprecate = __webpack_require__(4)('express');
var flatten = __webpack_require__(114);
var mime = __webpack_require__(132).mime;
var etag = __webpack_require__(139);
var proxyaddr = __webpack_require__(146);
var qs = __webpack_require__(122);
...
var escapeHtml = __webpack_require__(104)
var etag = __webpack_require__(139)
var fresh = __webpack_require__(141)
var fs = __webpack_require__(27)
var mime = __webpack_require__(142)
var ms = __webpack_require__(144)
var onFinished = __webpack_require__(78)
var parseRange = __webpack_require__(145)
var path = __webpack_require__(9)
var statuses = __webpack_require__(15)
...
var escapeHtml = __webpack_require__(104);
var http = __webpack_require__(118);
var isAbsolute = __webpack_require__(129).isAbsolute;
var onFinished = __webpack_require__(78);
var path = __webpack_require__(9);
var statuses = __webpack_require__(15)
var merge = __webpack_require__(119);
var sign = __webpack_require__(158).sign;
var normalizeType = __webpack_require__(129).normalizeType;
var normalizeTypes = __webpack_require__(129).normalizeTypes;
var setCharset = __webpack_require__(129).setCharset;
var cookie = __webpack_require__(159);
...
const content_security_policy_1 = __importDefault(__webpack_require__(163));
const expect_ct_1 = __importDefault(__webpack_require__(164));
const referrer_policy_1 = __importDefault(__webpack_require__(165));
const strict_transport_security_1 = __importDefault(__webpack_require__(166));
const x_content_type_options_1 = __importDefault(__webpack_require__(167));
const x_dns_prefetch_control_1 = __importDefault(__webpack_require__(168));
const x_download_options_1 = __importDefault(__webpack_require__(169));
const x_frame_options_1 = __importDefault(__webpack_require__(170));
const x_permitted_cross_domain_policies_1 = __importDefault(__webpack_require__(171));
const x_powered_by_1 = __importDefault(__webpack_require__(172));
const x_xss_protection_1 = __importDefault(__webpack_require__(173));
